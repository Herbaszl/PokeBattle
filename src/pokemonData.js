const pokemonData = [
  ...
  },
  {
    ...
    type: "Grass",
    attacks: [
        {name: "Solar Beam", damage: 10, accuracy: 0.8,  uses: 5},
        {name: "Razor Leaf", damage: 8, accuracy: 1.0, uses: 5},
    ],
  },
   {
    name: "Venusaur",
  ...
  },
  {
    ...
    type: "Fire",
    attacks: [
      { name: "Flamethrower", damage: 5, accuracy: 0.95, uses: 10 },
      { name: "Metal Claw", damage: 10, accuracy: 0.75, uses: 5 },
    ],
  },
    {
    name: "Charizard",
    ...
    type: "Fire",
    attacks: [
      { name: "Fly", damage: 8, accuracy: 0.95, uses: 10 },
      { name: "Flame Burst", damage: 13, accuracy: 0.75, uses: 5 },
    ],
  },
  {
    name: "Squirtle",
